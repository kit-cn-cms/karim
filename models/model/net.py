...
from models.model.dynamic_reduction_network import DynamicReductionNetwork
from models.model.graph_met_network import GraphMETNetwork_fix, GraphMETNetwork_dyn, GraphMETNetwork_simple
...
class Net(nn.Module):
    def __init__(self, continuous_dim, categorical_dim, output_dim, hidden_dim, conv_depth, mode):
        ...
        else: print("Error: please check if mode is simple, fix or dyn")
